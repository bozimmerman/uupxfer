...
_XFIDUN
        JMP NMIRES
; INPUT/RECEIVE NMI HANDLER -- DOES EVERYTHING -- ALL IN ONE!
XFINPUT
        NOP
        JSR CLRACT; YEA, SO CLEAR THE RESPONSE FLAG
...
_XINMI6
        ...
        JMP CLRACT
PRINT
        NOP;:F$="UUPX64.BAS":OPEN8,8,15,"S0:UUPX64.*":SAVEF$,8:VERIFYF$,8
